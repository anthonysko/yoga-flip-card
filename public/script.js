document.addEventListener('DOMContentLoaded', () => {
  ...
  const poses = [
    ...
    { sanskrit: "Upavistha Konasana", english: "Side Split Forward Bend Pose", group: "sitting", image: "https://via.placeholder.com/200?text=Upavistha+Konasana" },
  ...
  function nextCard() {
    ...
    isSanskritFirst = revisionMode.value === "sanskrit-to-english";
    displayCard();
  }
  ...
  revisionMode.addEventListener("change", changeMode);
  randomMode.addEventListener("change", toggleRandomMode);
  ...
  document.addEventListener("keydown", (event) => {
    if (event.key === "ArrowRight") {
      ...
      randomMode.checked = !randomMode.checked;
      toggleRandomMode();
